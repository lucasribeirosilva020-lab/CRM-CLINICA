    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <form
                ...
                className="bg-white w-full max-w-lg rounded-2xl shadow-modal overflow-hidden animate-slide-in-up"
            >
                <div className="px-6 py-4 border-b border-border flex items-center justify-between bg-gray-50/50">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-sm font-bold text-text">Novo Cliente (Paciente)</h2>
                    </div>
                ...
                <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                    ...
                    {formData.tipoPagamento !== 'PARTICULAR' && (
                        <div className="grid grid-cols-2 gap-4 p-3 rounded-xl bg-gray-50 border border-border animate-fade-in">
                            <div className="col-span-2 text-[10px] font-bold text-text-muted uppercase">Dados do Convênio</div>
                            <div>
                ...
                <div className="p-6 bg-gray-50 flex gap-3">
                    ...
                    <button type="submit" className="btn-primary flex-1 justify-center gap-2">
